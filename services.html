...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Services</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
                ...
                <div class="row gap-130">
                    <div class="col-md-6">
                        <div class="feature-item-three wow fadeInUp delay-0-2s">
                            <div class="top-part">
                                ...
                                <a class="details-btn" href="service-details.html"><i class="far fa-arrow-right"></i></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-6">
                        <div class="feature-item-three wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <h4><a href="service-details.html">Application Development</a></h4>
                    ...
                    <div class="col-md-6">
                        <div class="feature-item-three wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <h4><a href="service-details.html">Digital Product Design</a></h4>
                                <p>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid commodie </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="feature-item-three wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <h4><a href="service-details.html">Business Development</a></h4>
                                <p>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid commodie </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item-three wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <h4><a href="service-details.html">eCommerce Development</a></h4>
                                <p>We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="testimonial-section pt-95 rpt-65 pb-130 rpb-100">

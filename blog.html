...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Blog</title>
    <!-- Favicon Icon -->
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Blog Grid</h2>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-2s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Voice Skills For Google Assistant And Amazon Alexa</a></h4>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-4s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Inclusive Design And Accessibility Stream Heydon Pickering</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-6s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Creating Online Environments The Work Well For Older Users</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-2s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Tips Conducting Usability Studies With Participants Disabilities</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-4s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Online Environments That Work Well For Older Users</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-6s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Building Accessible Menu Systems Assistive Technology Users</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-2s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Inclusive Design And Accessibility Live Stream Heydon Pickering</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-4s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">3d Cartoon Woman Sitting and Thinking to Solve Tasks</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item wow fadeInUp delay-0-6s">
                            ...
                            <hr>
                            <h4><a href="blog-details.html">Poster frame in living room mock up family member's hands holding</a></h4>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-12">

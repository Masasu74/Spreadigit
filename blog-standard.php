...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Blog Standard</title>
    <!-- Favicon Icon -->
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Blog Standard</h2>
                ...
                <div class="row gap-60">
                    <div class="col-lg-8">
                        <div class="blog-item blog-standard wow fadeInUp delay-0-2s">
                            ...
                            <h3><a href="blog-details.html">Voice Skills For Google Assistant And Amazon Alexa</a></h3>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam aperiam, eaque ipsa quae ab illo inventore veritatis et quasi beatae vitae dicta sunt explicabo.</p>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="blog-item blog-standard blog-blockquote wow fadeInUp delay-0-2s">
                            <ul class="blog-meta">
                                <li>
                                    <i class="fal fa-user-alt"></i>
                                    <a href="#">Richard N. Dixon</a>
                            ...
                            <h3><a href="blog-details.html">Online Environments Work Well For Older Users</a></h3>
                            <p>Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque laudantium aperiam, eaque ipsa quae ab illo inventore veritatis et quasi beatae vitae.</p>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="blog-item blog-standard blog-video wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/blog/blog-standard2.jpg" alt="Blog">
                                <a href="https://www.youtube.com/watch?v=9Y7ma241N8k" class="mfp-iframe video-play"><i class="far fa-play"></i></a>
                            </div>
                            <ul class="blog-meta">
                                <li>
                                    <i class="fal fa-user-alt"></i>
                            ...
                            <h3><a href="blog-details.html">Inclusive Design And Accessibility: Live Stream With Heydon Pickering</a></h3>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam aperiam, eaque ipsa quae ab illo inventore veritatis et quasi beatae vitae dicta sunt explicabo.</p>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="blog-item blog-standard blog-blockquote wow fadeInUp delay-0-2s">
                            ...
                            <h3><a href="blog-details.html">UX Optimizations For Keyboard-Only And Assistive Technology Users</a></h3>
                            <p>Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque laudantium aperiam, eaque ipsa quae ab illo inventore veritatis et quasi beatae vitae.</p>
                            <a class="read-more" href="blog-details.html">Read More <i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="blog-item blog-standard wow fadeInUp delay-0-2s">

                ...
                <div class="row gap-90 align-items-center">
                    <div class="col-lg-6">
                        <div class="service-about-image rmb-55 wow fadeInUp delay-0-2s">
                            <img src="assets/images/about/web-design.png" alt="About">
                    ...
                    <div class="col-xl-5 col-lg-6 mx-xl-auto">
                        <div class="about-content wow fadeInUp delay-0-4s">
                            <div class="section-title mb-40">
                                ...
                                <h2>Crafting Your Unique Web Design Experience
</h2>
                            </div>
                            <div class="content">
                                <p>Create intuitive and visually stunning web app interfaces tailored to your business needs and user preferences.</p>
                                <ul class="list-style-three pt-15 pb-25">
                                    <li>Create user-friendly interfaces.</li>
      <li>Ensure compatibility across devices.</li>
      <li>Incorporate modern design trends.</li>
            ...
            <div class="container">
                <div class="section-title mb-40 wow fadeInUp delay-0-2s">
                    ...
                    <div class="text mt-30">
                        <p>Follow Our Simple Steps to Craft an Intuitive Web App Experience. From Ideation to Launch, We'll Be with You Every Step of the Journey.</p>
                    </div>
                </div>
                ...
                <div class="row gap-90">
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <p> Explore the purpose and functionality of your web app, understanding user needs and preferences.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <p>Create intuitive and visually appealing designs for your web app interface.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <p>Convert design concepts into functional prototypes or wireframes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item arrow-none wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <p>Implement the finalized design into the development process.</p>
                            </div>
                        </div>
                    </div>
                </div>

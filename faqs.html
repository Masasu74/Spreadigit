...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || FAQs</title>
    <!-- Favicon Icon -->
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Faqs</h2>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 order-lg-2">
                       <div class="faq-iamge-part text-lg-end rmb-55 wow fadeInLeft delay-0-2s">
                    ...
                    <div class="col-lg-7">
                        <div class="faq-content-part wow fadeInRight delay-0-2s">
                            ...
                            <div class="accordion" id="faq-accordion-two">
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseTwoThree">
                                            How many revisions can i make the design ?
                                        </button>
                                    </h5>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseTwoFour">
                                            Will you provide website layout about design ?
                                        </button>
                                    </h5>

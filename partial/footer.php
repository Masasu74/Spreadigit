                ...
                <div class="row gap-80 justify-content-between">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-widget footer-info wow fadeInUp delay-0-6s">
                            ...
                            <ul class="list-style-two">
                                <li><i class="far fa-map-marker-alt"></i> <span>Kigali,Rwanda</span></li>
                                <li><i class="far fa-envelope"></i> <a
                                        href="mailto:support@gmail.com">spreadigit@gmail.com</a></li>
                                <li><i class="far fa-phone"></i> <a href="callto:+000(123)45688">+250 783 876 662</a>
                                </li>
                            </ul>
                        </div>
                    </div>

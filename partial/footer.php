            ...
            <div class="container">
                <div class="row gap-80 justify-content-between">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget newsletter-widget wow fadeInUp delay-0-2s">
                            <div class="footer-logo mb-20">
                                <a href="index.php"><img src="assets/images/logos/footer-logo.png" alt="Logo"></a>
                            </div>
                            <div class="text mb-25">Ut enim ad minima veniam nostrum exercitationem ullam corporise
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-widget footer-info wow fadeInUp delay-0-6s">
                            ...
                            <ul class="list-style-two">
                                <li><i class="far fa-map-marker-alt"></i> <span>Baird House, 15-17 St Cross StLondon
                                        EC1N 8UW</span></li>
                                <li><i class="far fa-envelope"></i> <a
                                        href="mailto:support@gmail.com">support@gmail.com</a></li>
                                <li><i class="far fa-phone"></i> <a href="callto:+000(123)45688">+000 (123) 456 88</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="copyright-area rel mt-25 pt-35 pb-25">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="footer-copyright-text wow fadeInUp delay-0-2s">
                                <p>Copyright @2024, <a href="index.php">Spreadigit</a> All Rights Reserved</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <button class="scroll-top scroll-to-target" data-target="html"><span
                            class="far fa-chevron-double-up"></span></button>
                </div>
            </div>
        </footer>
...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Team</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Expert Team</h2>
                ...
                <div class="row gap-120 align-items-center justify-content-between">
                    ...
                    <div class="col-lg-7">
                        <div class="skill-content pt-40 rpt-60 wow fadeInUp delay-0-4s">
                            ...
                            <p>Similique sunin culpa qui officia deserunt mollitia animi est laborum et dolorum fuga. Et harum quidem rerum facilis esty expedita distinctioam nobis est eligendi optio cumquey</p>
        ...
        <!-- Team Area start -->
        <section class="team-page-area pt-130 rpt-100 pb-70 rpb-40 rel" style="background-image: url(assets/images/hero/hero-two-bg.png);">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/team/member-two1.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-4s">
                            <div class="image">
                                <img src="assets/images/team/member-two2.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-6s">
                            <div class="image">
                                <img src="assets/images/team/member-two3.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/team/member-two4.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-4s">
                            <div class="image">
                                <img src="assets/images/team/member-two5.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                                <h4>Michael A. Braun</h4>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-6s">
                            <div class="image">
                                <img src="assets/images/team/member-two6.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/team/member-two7.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-4s">
                            <div class="image">
                                <img src="assets/images/team/member-two8.jpg" alt="Team Member">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="team-member style-two wow fadeInUp delay-0-6s">
                            <div class="image">
                                <img src="assets/images/team/member-two9.jpg" alt="Team Member">
                            </div>
                            <div class="content">

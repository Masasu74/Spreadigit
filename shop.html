...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Shop</title>
    <!-- Favicon Icon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item wow fadeInUp delay-0-6s">
                            ...
                            <div class="content">
                                <a class="category" href="#">Product Design</a>
                                <h5><a href="product-details.html">Mobile Application Design</a></h5>
                                <div class="ratting-price">
                                    <div class="ratting">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <a class="category" href="#">Product Design</a>
                                <h5><a href="product-details.html">T-shirt Mockup Design</a></h5>
                                <div class="ratting-price">
                                    <div class="ratting">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <a class="category" href="#">Product Design</a>
                                <h5><a href="product-details.html">Business Card Mockup</a></h5>
                                <div class="ratting-price">
                                    <div class="ratting">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-item wow fadeInUp delay-0-6s">
                            ...
                            <div class="content">
                                <a class="category" href="#">Product Design</a>
                                <h5><a href="product-details.html">Logo Design & Branding</a></h5>
                                <div class="ratting-price">
                                    <div class="ratting">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>

...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Projects</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
                ...
                <div class="container container-1620 clearfix">
                    ...
                    <div class="header-inner rpy-10 rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="assets/images/logos/logo-white.png.html" alt="Logo" title="Logo"></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header py-10">
                                   <div class="mobile-logo">
                                       <a href="index.html">
                                            <img src="assets/images/logos/logo-white.png.html" alt="Logo" title="Logo">
                                       </a>
                                   </div>
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Project Slider</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center wow fadeInUp delay-0-4s">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active">Project Slider</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="project-slider-area py-130 rpy-100">
            <div class="container">
               <div class="project-slider-two-active">
                    <div class="project-item style-six">
                        <div class="image wow fadeInUp delay-0-2s">
                            <img src="assets/images/projects/project-slider-two1.jpg" alt="Project Slider">
                            <a href="project-details.html" class="project-btn"><i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="content wow fadeInUp delay-0-2s">
                            <a href="projects.html" class="category">Creative Work</a>
                            <h4><a href="project-details.html">Task Management Dashboard</a></h4>
                        </div>
                    </div>
                    <div class="project-item style-six">
                        <div class="image wow fadeInUp delay-0-2s">
                            <img src="assets/images/projects/project-slider-two2.jpg" alt="Project Slider">
                            <a href="project-details.html" class="project-btn"><i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="content wow fadeInUp delay-0-2s">
                            <a href="projects.html" class="category">Creative Work</a>
                    ...
                    <div class="project-item style-six">
                        <div class="image wow fadeInUp delay-0-2s">
                            <img src="assets/images/projects/project-slider-two3.jpg" alt="Project Slider">
                            <a href="project-details.html" class="project-btn"><i class="far fa-arrow-right"></i></a>
                        </div>
                        <div class="content wow fadeInUp delay-0-2s">
                            <a href="projects.html" class="category">Creative Work</a>

            ...
            <div class="container container-1290">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        Sip and Snack Coffee shop menu and loyalty cards
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="project-details-image rel z-1">
            <div class="container-fluid">
                <div class="image wow fadeInUp delay-0-2s">
                    <img src="../assets/images/projects/project-details4.png" alt="Project">
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="image mb-30 wow fadeInUp delay-0-2s">
                            <img src="../assets/images/projects/sip.png" width="80%" alt="Project">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="image mb-30 wow fadeInUp delay-0-4s">
                            <img src="../assets/images/projects/sip1.png" width="80%" alt="Project">
                        </div>
                    </div>
                </div>

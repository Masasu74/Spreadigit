...
<head>
    ...
    <!-- Title -->
    <title>Ygency - Web Agency HTML Template || Pricing</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-banner-area overlay pt-220 rpt-150 pb-170 rpb-100 rel z-1 bgs-cover text-center" style="background-image: url(assets/images/banner/banner-bg.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Pricing Plan</h2>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        <div class="row">
                            <div class="col-xl-11">
                                <div class="why-choose-left-content mb-30 rmb-55 wow fadeInLeft delay-0-2s">
                                    ...
                                    <p>Desire that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs</p>
                                    <a class="theme-btn style-two mt-35" href="about.html">Learn More <i class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="service-item wow fadeInRight delay-0-2s">
                                    ...
                                    <h5><a href="service-details.html">Ontime meeting <br>with experts</a></h5>
                                    <p>We denounce with righteous indignatio dislike men who are beguiled and demoralized</p>
                                </div>
                                <div class="service-item wow fadeInRight delay-0-3s">
                                    <div class="icon">
                                        <i class="fal fa-cogs"></i>
                                    </div>
                                    <h5><a href="service-details.html">Quality check by <br>expert members</a></h5>
                                    <p>Quis autem veleum voluptate velit quam mole conse quatur veillum qui dolorem eum</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-item mt-30 wow fadeInRight delay-0-4s">
                                    ...
                                    <h5><a href="service-details.html">Detailed report <br>submission</a></h5>
                                    <p>At vero eos et accusamus et iusto odio dignissimo ducimus qui blanditiis praesentium</p>
                                </div>
                                <div class="service-item wow fadeInRight delay-0-5s">
                                    <div class="icon">
                                        <i class="fal fa-shield-cross"></i>
                                    </div>
                                    <h5><a href="service-details.html">Filtering projects <br>for mass tax</a></h5>
                                    <p>To take trivial example which ever under laborious physical exercise to advantage</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="pricing-area-three pb-85 rpb-55" style="background-image: url(assets/images/background/pricing-bg-dot-shape.png)">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="pricing-plan-item wow fadeInUp delay-0-4s">
                           <span class="badge">
                            ...
                            <span class="price-text"><span class="before">$</span><span class="price">49.3</span> <span class="after">/per month</span></span>
                            <ul class="list-style-one">
                                <li>Landing Page Design</li>
                                <li>Web Development</li>
                                <li>SEO Optimizations</li>
               ...
               <div class="row justify-content-center pb-45 rpb-25">
                    <div class="col-xl-7 col-lg-9">
                        <div class="section-title text-center wow fadeInUp delay-0-2s">
                            ...
                            <a class="explore-more text-start mt-30" href="contact.html"><i class="fas fa-arrow-right"></i> <span>Explore more</span></a>
                        </div>
                    </div>
                </div>
            </div>

...
<body>
    <div class="page-wrapper">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="row">
                            <div class="col-xl-10">
                                <div class="section-title mb-30 wow fadeInRight delay-0-2s">
                                    ...
                                    <div class="text pt-20">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service-item style-two wow fadeInLeft delay-0-2s">
                            ...
                            <h5><a href="service-details.html">Make Strategy</a></h5>
                            <p>Sedut persiciatis unde omnis este natus error volutat</p>
                            <a class="read-more style-two" href="service-details.html"><span>Read More</span> <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service-item style-two wow fadeInLeft delay-0-4s">
                            ...
                            <h5><a href="service-details.html">Project Testing</a></h5>
                            <p>Sedut persiciatis unde omnis este natus error volutat</p>
                            <a class="read-more style-two" href="service-details.html"><span>Read More</span> <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service-item style-two wow fadeInLeft delay-0-6s">
                            ...
                            <h5><a href="service-details.html">Project Lunch</a></h5>
                            <p>Sedut persiciatis unde omnis este natus error volutat</p>
                            <a class="read-more style-two" href="service-details.html"><span>Read More</span> <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
        ...
        <section class="pricing-plan-area pt-130 rpt-100 rel z-1">
            ...
            <div class="footer-bg-shape" style="background-image: url(assets/images/footer/footer-bg-shape-two.png)"></div>
        </section>
        <!-- Pricing end -->

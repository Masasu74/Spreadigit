                    ...
                    <div class="col-xl-5 col-lg-6 mx-xl-auto">
                        <div class="about-content wow fadeInUp delay-0-4s">
                            <div class="section-title mb-40">
                                ...
                                <h2>Crafting Your Unique Print Design Presence
</h2>
                            </div>
                            <div class="content">
                                <p>Stand out from the crowd with eye-catching print materials designed to leave a lasting impression on your audience.</p>
                                <ul class="list-style-three pt-15 pb-25">
                                         <li>Design visually appealing print materials.</li>
      <li>Tailor designs to audience and purpose.</li>
      <li>Ensure print-readiness and quality.</li>
            ...
            <div class="container">
                <div class="section-title mb-40 wow fadeInUp delay-0-2s">
                    ...
                    <div class="text mt-30">
                        <p>Follow Our Simple Steps to Design Eye-Catching Print Materials. From Idea to Print, We'll Be Your Guide Every Step of the Process.</p>
                    </div>
                </div>
        ...
        Discover</h4>
                            <div class="content">
                                <p>Determine the purpose and audience for your print materials.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <p>Create visually striking designs for print materials such as brochures, flyers, or posters.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <p>Prepare print-ready files and ensure they meet printing specifications.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item arrow-none wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <p>Print and distribute the materials to your target audience.</p>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="row gap-90 align-items-center">
                    <div class="col-lg-6">
                        <div class="service-about-image rmb-55 wow fadeInUp delay-0-2s">
                            <img src="assets/images/about/mobile-dev.jpeg" alt="About">
                    ...
                    <div class="col-xl-5 col-lg-6 mx-xl-auto">
                        <div class="about-content wow fadeInUp delay-0-4s">
                            <div class="section-title mb-40">
                                ...
                                <h2>Crafting Your Unique Mobile App
</h2>
                            </div>
                            <div class="content">
                                <p>Bring your app idea to life with custom mobile app development services that cater to your business goals and user needs.</p>
                                <ul class="list-style-three pt-15 pb-25">
                                       <li>Create native or cross-platform apps.</li>
      <li>Design intuitive interfaces.</li>
      <li>Develop robust backend systems.</li>
                                </ul>
            ...
            <div class="container">
                <div class="section-title mb-40 wow fadeInUp delay-0-2s">
                    ...
                    <div class="text mt-30">
                        <p>Follow Our Simple Steps to Bring Your App Idea to Life. From Concept to Deployment, We'll Be with You at Every Stage of the Journey.</p>
                    </div>
                </div>
                <div class="row gap-90">
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <p>Define the purpose, target audience, and key features of your mobile app.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <p>Create wireframes and prototypes to visualize the app's layout and user experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <p>Build and code the app, ensuring it is compatible with various devices and platforms.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item arrow-none wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <p> Launch the app on app stores, monitor user feedback, and make updates as needed.</p>
                            </div>
                        </div>
                    </div>
                </div>

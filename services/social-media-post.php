                ...
                <div class="row gap-90 align-items-center">
                    <div class="col-lg-6">
                        <div class="service-about-image rmb-55 wow fadeInUp delay-0-2s">
                            <img src="../assets/images/about/social-media-post.png" alt="About">
                    ...
                    <div class="col-xl-5 col-lg-6 mx-xl-auto">
                        <div class="about-content wow fadeInUp delay-0-4s">
                            <div class="section-title mb-40">
                                ...
                                <h2>Crafting Your Unique Social Media Presence</h2>
                            </div>
                            <div class="content">
                                <p>Elevate your social media presence with captivating and on-brand post designs that engage your audience.</p>
                                <ul class="list-style-three pt-15 pb-25">
                                         <li>Design engaging posts for various platforms.</li>
      <li>Tailor designs to match brand identity.</li>
      <li>Use captivating visuals and persuasive copy.</li>
                                </ul>
            ...
            <div class="container">
                <div class="section-title mb-40 wow fadeInUp delay-0-2s">
                    ...
                    <div class="text mt-30">
                        <p>Follow Our Simple Steps to Create Stunning Social Media Posts. From Concept to Publishing, We'll Guide You at Every Turn.</p>
                    </div>
                </div>
                <div class="row gap-90">
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <p>Understand your brand's identity, target audience, and goals for social media presence.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <p>Create eye-catching and engaging social media posts consistent with your brand identity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <p>Translate post designs into various formats suitable for different social media platforms.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item arrow-none wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <p>Schedule and publish posts across your social media channels.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row gap-60">
                                <div class="col-md-6">
                                    <div class="why-choose-item wow fadeInUp delay-0-2s">
                                        ...
                                        <p>We use strategic marketing tactics that have been proven programming</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="why-choose-item wow fadeInUp delay-0-3s">
                                        ...
                                        <p>Devices show more pixels square inch resulting sharperes images Content</p>
                                    </div>
                                </div>
                            </div>
                        </div>

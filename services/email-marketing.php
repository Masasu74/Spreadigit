                ...
                <div class="row gap-90 align-items-center">
                    <div class="col-lg-6">
                        <div class="service-about-image rmb-55 wow fadeInUp delay-0-2s">
                            <img src="../assets/images/about/email-marketing.jpg" alt="About">
                    ...
                    <div class="col-xl-5 col-lg-6 mx-xl-auto">
                        <div class="about-content wow fadeInUp delay-0-4s">
                            <div class="section-title mb-40">
                                ...
                                <h2>Crafting Your Unique Email Campaigns
</h2>
                            </div>
                            <div class="content">
                                <p>Connect with your audience on a personal level through engaging email campaigns that drive conversions and loyalty.</p>
                                <ul class="list-style-three pt-15 pb-25">
                                         <li>Design appealing email templates.</li>
      <li>Develop personalized campaigns.</li>
                ...
                <div class="row gap-90">
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-2s">
                            ...
                            <div class="content">
                                <p>Identify your email marketing goals and target audience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <p>QCreate visually appealing email templates consistent with your brand identity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <p>Craft engaging email content and personalized messages.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="work-step-item arrow-none wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <p>Send targeted email campaigns and analyze performance metrics.</p>
                            </div>
                        </div>
                    </div>
                </div>

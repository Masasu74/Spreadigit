...
<body>
    <div class="page-wrapper">
       ...
       <!-- Team Profile Area start -->
        <section class="team-profile-area pt-220 rpt-150 pb-130 rpb-100 rel" style="background-image: url(assets/images/hero/hero-two-bg.png);">
                        ...
                        <div class="team-profile-content wow fadeInRight delay-0-2s">
                            ...
                            <div class="contact-info-item">
                                ...
                                <div class="content">
                                    ...
                                    <span class="text"><a href="mailto:support@gmail.com">support@gmail.com</a></span>
                                </div>
                            </div>
                            <div class="contact-info-item">
                                <div class="icon">
                                ...
                                <div class="content">
                                    ...
                                    <span class="text"><a href="callto:+00012345688">+000 (123) 456 88</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
               <div class="row justify-content-center">
                    ...
                    <div class="col-xl-10 col-lg-11">
                        <form id="teamForm" class="form-style-one z-1 rel wow fadeInUp delay-0-3s"  action="#" name="teamForm" method="post">
